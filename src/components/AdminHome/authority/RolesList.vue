<template>
  <div class="content">
    ...
    <el-card class="box-card" shadow="never">
      ...
      <span>数据列表</span>
      <el-button class="btn-add" style="float: right" size="mini">
        添加
      </el-button>
    </el-card>
    ...
    <div class="table_content">
      ...
      >
        ...
        <el-table-column prop="bookName" label="角色名称" align="center">
        </el-table-column>
        <el-table-column prop="rank" label="描述" align="center">
        </el-table-column>
        <el-table-column prop="rank" label="用户数" align="center">
        </el-table-column>
        <el-table-column prop="author" label="添加时间" align="center">
        </el-table-column>
          ...
          for (let i = 0; i < list.length; i++) {
            ...
            if (list[i].children != null && list[i].children.length > 0) {
              for (let j = 0; j < list[i].children.length; j++) {
                children.push({
                  label: list[i].children[j].sortName,
            ...
            console.log(list[i]);
            this.options.push({
              label: list[i].upperSort.sortName,
              value: list[i].upperSort.id,
              children: children,
            });
          }
        }else{
